...
for t in list_time:
    for date_me in range(1,32):
        for i in range(1,291):
                try:
                    if date_me <= 9:
                        date_me_temp = str("0"+str(date_me))
                    url = 'https://movement.uber.com/explore/new_delhi/travel-times/query?lang=hi-IN&si=%s&ti=1&ag=wards&dt[tpb]=%s&dt[wd;]=1,2,3,4,5,6,7&dt[dr][sd]=2016-12-%s&dt[dr][ed]=2016-12-%s&cd=&lat.=28.6203201&lng.=77.1405719&z.=13&sa;=&sdn=&ta;=&tdn='%(i,t,date_me_temp,date_me_temp)
